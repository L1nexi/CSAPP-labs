...
// static void bar_my([[maybe_unused]] void*)
// {
//     print("bar_my");
//     print("exiting bar_my");
//     return;
// }
// static void foo_my([[maybe_unused]] void*)
// {
//     print("foo_my");
//     coro::coroutine* co2 = coro::create(bar_my, nullptr);
//     coro::resume(co2);
//     coro::release(co2);
//     print("exiting foo_my");
//     return;
// }
// void test_my()
// {
//     coro::coroutine* co1 = coro::create(foo_my, nullptr);
//     coro::resume(co1);
//     coro::release(co1);

//     std::cout << "test-my passed" << std::endl;
// }
